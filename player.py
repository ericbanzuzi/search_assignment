...
class PlayerControllerMinimax(PlayerController):
    ...
    def heuristic(self, node):
        ...
        if len(fish_positions.keys()) == 0 and current_score > 0:
            ...
            # Current score which tells us how good or bad we are doing --> 100
            # then to future possible caught fishes --> 10
            # and lastly giving higher importance to good actions from the present (caught fish) --> 1000
